...
public class Reservebook extends javax.swing.JFrame {
    ...
    public void book_status() {
        ...
        String sql = "update  books set book_status='reserved' WHERE book_id='" + book_id + "' ";
        Connection connection = db.Connect();
        try {
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        String sql = "SELECT * FROM books WHERE  book_id='" + book_id + "' AND book_status NOT IN ('Available')";
        try {
            ...
            if (rs.next()) {
                ...
                sql = "Insert into borrowed_books (`book_id`, `book_name`, `issued_date`, `return_date`, `adm_No`, `book_status`) values('" + book_id + "','" + book_Name + "','" + strDate + "','" + dite + "','" + adm_No + "','reserved')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Reservebook.class
