...
public class uresrvebook extends javax.swing.JFrame {
...
//            NID.setText(Model.getValueAt(i, 3).toString());
    ...
    private void Load_books() {
        ...
        try {
            ...
            String sql = "SELECT `book_name`, `adm_No`, `book_id`FROM borrowed_books WHERE book_status='reserved'";
            PreparedStatement preparedStatement = connection.prepareStatement(sql);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(uresrvebook.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new uresrvebook().setVisible(true);
            }
        });
    }
